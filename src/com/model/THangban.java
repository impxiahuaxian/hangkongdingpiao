...
/**
 * THangban generated by MyEclipse Persistence Tools
 */

public class THangban implements java.io.Serializable//因为这是一个Java实体类，里面有一个Spring用来管理、维护JavaBean之间的关系，满足JavaBean的条件之一就是要实现序列化接口
{
